...
memesSchema.pre("remove", function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            fs_1.default.unlink("./images/" + this.img.fileName, function () { });
            return [2 /*return*/];
        });
    });
});
memesSchema.pre("save", function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (this.img.isModified("fileName")) {
                if (this.img._fileName) {
                    fs_1.default.unlink("./images/" + this.img._fileName, function () { });
                }
            }
            return [2 /*return*/];
        });
